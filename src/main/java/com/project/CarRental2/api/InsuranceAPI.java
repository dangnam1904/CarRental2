...
public class InsuranceAPI {
    ...
    // public String saveInsuranceEdit(Model model, @ModelAttribute("insurance")
    // Insurance insurance,
    ...
    // insuranceService.getInsuranceById(insurance.getIdInsurance());
    ...
    // public String saveInsurance(Model model, @ModelAttribute("insurance")
    // Insurance insurance,
    // @RequestParam(name = "image", required = false) MultipartFile img,
    // HttpServletRequest request) {
    // HttpSession session = request.getSession();
